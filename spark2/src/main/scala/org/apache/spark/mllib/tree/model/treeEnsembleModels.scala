...
package org.apache.spark.mllib.tree.modelicious.model
...
import org.apache.spark.mllib.tree.modelicious.configuration.Algo
import org.apache.spark.mllib.tree.modelicious.configuration.Algo._
import org.apache.spark.mllib.tree.modelicious.configuration.EnsembleCombiningStrategy._
...
object RandomForestModel extends Loader[RandomForestModel] {
  ...
  private object SaveLoadV1_0 {
    ...
    def thisClassName: String = "org.apache.spark.mllib.tree.modelicious.model.RandomForestModel"
  }
...
private[tree] object TreeEnsembleModel extends Logging {
  ...
  object SaveLoadV1_0 {
    ...
    import org.apache.spark.mllib.tree.modelicious.model.DecisionTreeModel.SaveLoadV1_0.{NodeData, constructTrees}
