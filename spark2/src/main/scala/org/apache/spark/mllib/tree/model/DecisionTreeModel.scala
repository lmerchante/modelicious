...
import org.apache.spark.mllib.tree.modelicious.configuration.{Algo, FeatureType}
...
object DecisionTreeModel extends Loader[DecisionTreeModel] with Logging {
  ...
  private[tree] object SaveLoadV1_0 {
    ...
    def thisClassName: String = "org.apache.spark.mllib.tree.modelicious.model.DecisionTreeModel"
